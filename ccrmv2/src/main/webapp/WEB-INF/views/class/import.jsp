...
<body>
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title">为&nbsp;<b>${loginName}</b>&nbsp;导入学员</h4>
		</div>
		...
		<div>
			培训学员导入模版下载：<a href="<%=request.getContextPath()%>/tirStudent/downloadTemplate">培训学员导入模版.xls</a>
		</div>
		<div></div>
	...
	<script>
		...
		function saveUserRole() {
			...
			$.ajax({
				url : path + "/mgtuser/saveMgtUserAuth",
				data : {
